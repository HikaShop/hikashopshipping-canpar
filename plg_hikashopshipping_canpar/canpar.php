...
* @subpackage shipping
* @author Parameshwar (Ravi) Roy
* @copyright Copyright (C) 2014 Parameshwar (Ravi) Roy - All rights reserved.
...
";
	...
	function _RequestMethods($data, $packages) {
		...
		//Packages with a combined length and width greater than 130 inches (330 cm) but less than 165 inches (419 cm)
		//$xccalc = $package['length'] + $package['width'];
		//$xtra_care = ($xccalc > 130 && $xccalc < 165)?1:0;

		$xtra_care = 0;

		/*$total_count = $data['quantity'];
		$shipping_weight = $data['weight'];*/
